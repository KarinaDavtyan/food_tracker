...
//  FoodTracker
//
//  Created by Карина on 22/06/2018.
...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        //Hide the keyboard, resign the text field’s first-responder status
    ...
    @IBAction func selectImageFromPhotoLibrary(_ sender: UITapGestureRecognizer) {
        ...
        //you can write its value as the abbreviated form .photoLibrary instead of UIImagePickerControllerSourceType.photoLibrary. Recall that you can use the abbreviated form anytime the enumeration value’s type is already known.
